...
public interface TherapistRepository  extends JpaRepository<Therapist, Integer> {
	...
	@Query(
	value = "SELECT expediente.id_expediente, expediente.\"estadoPaciente\", nombre, apellidop, apellidom FROM expediente\n" + 
	...
	nativeQuery = true)
	List<Object> findTherapistRecords(@Param("therapistId") Integer therapistId );
}
